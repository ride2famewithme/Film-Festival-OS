...
import { ArrowLeft,CheckCircle2,Plus,RefreshCw } from 'lucide-react-native';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import { THEME } from '@/constants/theme';
import { createSubmission,listSubmissions,queueSubmissionNotification,updateSubmissionStatus } from '@/data/workflows/festival-core';
export default function Submissions(){const i=useSafeAreaInsets();const [rows,setRows]=useState<any[]>([]);const [title,setTitle]=useState('');const [name,setName]=useState('');const [email,setEmail]=useState('');const [busy,setBusy]=useState(false);
